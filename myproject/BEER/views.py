...
def ver1(request):
    beer_list = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/beerName.csv', engine='python', index_col=0)
    beer_year = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/averageAnnualRating.csv', engine='python', index_col=0)
    ratings = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/afterPreprocessing.csv', engine='python', index_col=0)
    cluster_3 = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/clusterRepresentative.csv', engine='python', index_col=0)
    cluster_all = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/clusterAllvalues.csv', engine='python', index_col=0)
    beer_data = pd.read_csv('/home/hanbin96/Beer_Recommendation/myproject/beerCBFdata.csv', engine='python', index_col=0)
